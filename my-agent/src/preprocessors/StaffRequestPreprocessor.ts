/**
 * Routes staff "tell my manager / unpaid wages / payslip / visa docs" messages
 * through staff_request so details are logged on the manager dashboard —
 * not lost in chat or faked as "confirmation card" / inform_staff pings.
 */
...
export const staffRequestPreprocessor = new PreProcessor({
    ...
    description:
        "Routes staff manager-forwarding and payslip/wage/document asks through staff_request with full details.",
