...
export default class RestaurantLookupTool {
    constructor(apiService) {
        this.name = "get_restaurant_context";
        this.description = "Look up restaurant ID by name. Use this when you know the restaurant name but need the ID.";
    ...
    async execute(input, context) {
        ...
        try {
            ...
            const match = restaurants.find((r) => r.name.toLowerCase() === input.restaurant_name.toLowerCase()) || restaurants[0];
