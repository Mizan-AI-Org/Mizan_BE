...
echo "Space supervisor persona:"
echo "  Automated: $SCRIPT_DIR/push-space-persona.sh"
echo "  Manual file: $SCRIPT_DIR/miya-space-persona.txt"
echo "  Quick copy: pbcopy < $SCRIPT_DIR/miya-space-persona.txt"
echo ""
echo "Next steps:"
echo "  1. Space persona is pushed via push-space-persona.sh (or paste miya-space-persona.txt in Miya Space → Personality)"
