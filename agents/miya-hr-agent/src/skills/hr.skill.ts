...
export const hrSkill = new LuaSkill({
  ...
  description:
    ...
    "and licenses, restaurant compliance doc expiry (insurance, hygiene, permits), " +
  ...
  context:
    ...
    "staff document management (licenses, certificates with expiry tracking), restaurant " +
    "compliance documents (insurance, hygiene, fire extinguishers, business registration), " +
    "staff PDF reports, kudos/recognition awards, role grants/changes, and account activation by phone. " +
