...
export default class RecognitionTool implements LuaTool {
    name = "recognize_staff";
    description =
        "Give a public recognition / kudos / safety recognition to a staff member, or list recent ones. " +
    ...
    async execute(input: z.infer<typeof this.inputSchema>) {
        ...
        // award
        if (!input.title || !input.title.trim()) return validationError("title is required.");
