...
class PlatformWhatsAppConfig(models.Model):
    ...
    # Miya TTS identity (Fish Audio reference voice — young female by default)
    miya_fish_reference_id = models.CharField(max_length=64, blank=True, default="")
    miya_fish_model = models.CharField(max_length=32, blank=True, default="s2.1-pro")
    miya_voice_speed = models.FloatField(default=1.05)
    miya_voice_label = models.CharField(max_length=64, blank=True, default="Sarah")
    miya_openai_fallback_voice = models.CharField(max_length=32, blank=True, default="shimmer")
