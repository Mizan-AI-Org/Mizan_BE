...
class ResolveWidgetAliasTests(SimpleTestCase):
    ...
    def test_team_leave_request_resolves_to_team_travel(self):
        self.assertEqual(
            resolve_widget_alias("create a widget for team leave request"),
            "team_travel",
        )

    def test_team_travelling_phrase_resolves_to_team_travel(self):
        self.assertEqual(
            resolve_widget_alias("handle team travelling needs and requests"),
            "team_travel",
        )
    ...
    def test_team_medical_service_widget_phrase_resolves(self):
        self.assertEqual(
            resolve_widget_alias("Create a Team Medical Service widget"),
            "team_medical_service",
        )

    def test_team_medical_service_title_resolves(self):
        self.assertEqual(
            resolve_widget_alias("Team Medical Service"),
            "team_medical_service",
        )
