...
_ALIASES: dict[str, str] = {
    ...
    # ---- leave / time-off (staff inbox — SCHEDULING requests) -----------
    "leave request": "staff_inbox",
    "leave requests": "staff_inbox",
    "team leave": "staff_inbox",
    "team leave request": "staff_inbox",
    "time off": "staff_inbox",
    "time off request": "staff_inbox",
    "time off requests": "staff_inbox",
    "holiday request": "staff_inbox",
    "holiday requests": "staff_inbox",
    "conge": "staff_inbox",
    "conges": "staff_inbox",
    "congé": "staff_inbox",
    "congés": "staff_inbox",
    "demande de conge": "staff_inbox",
    "demande de congé": "staff_inbox",
    "demandes de conge": "staff_inbox",
    "demandes de congé": "staff_inbox",
    "اجازة": "staff_inbox",
    "اجازات": "staff_inbox",
    # ---- finance ---------------------------------------------------------
    "finance": "finance",
