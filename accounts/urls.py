...
urlpatterns = [
    ...
    path('agent/platform-knowledge/', agent_platform_knowledge, name='agent_platform_knowledge'),
    ...
    path('agent/reservations/create/', agent_create_reservation, name='agent_create_reservation'),
