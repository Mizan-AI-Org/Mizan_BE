...
urlpatterns = [
    ...
    path('staff/invite/', StaffInvitationCreateView.as_view(), name='staff_invite'),
    path('staff/invite/accept/', StaffInvitationAcceptView.as_view(), name='staff_invite_accept'),
