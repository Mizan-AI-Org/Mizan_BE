    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geo_fence_radius', models.DecimalField(blank=True, decimal_places=2, max_digits=9, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restaurant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='staff', to='accounts.restaurant')),
            ],
            options={
                'db_table': 'users',
            },
