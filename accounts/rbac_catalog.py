...
APPS: list[dict[str, str]] = [
    ...
    {"id": "operations_live", "label": "Operations Live (daily demands & tasks)"},
...
ACTIONS: list[dict[str, str]] = [
    ...
    {"id": "manage_compliance_docs", "label": "Manage compliance documents & expiry reminders"},
    {"id": "configure_payment_approval", "label": "Configure PayGuard payment approval ladders"},
