...
from .views_agent import (
    ...
    agent_assign_staff_request,
    agent_search_operational_records,
    agent_chase_operational_record,
...
urlpatterns = [
    ...
    path('agent/requests/assign/', agent_assign_staff_request, name='agent-assign-staff-request'),
    path('agent/records/search/', agent_search_operational_records, name='agent-search-operational-records'),
    path('agent/records/chase/', agent_chase_operational_record, name='agent-chase-operational-record'),
