...
# ONE-TAP activation: digits-only phone for wa.me link (e.g. 14155551234). Fallback: WHATSAPP_PHONE_NUMBER_ID.
WHATSAPP_ACTIVATION_WA_PHONE = config('WHATSAPP_ACTIVATION_WA_PHONE', default='')
