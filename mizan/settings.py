...
# Agent brain: django (in-process OpenAI) | mastra (Miya-V2 Mastra service)
MIYA_AGENT_PROVIDER = config('MIYA_AGENT_PROVIDER', default='django')
MIYA_MASTRA_URL = config('MIYA_MASTRA_URL', default='http://127.0.0.1:4111')
MIYA_MASTRA_AGENT_ID = config('MIYA_MASTRA_AGENT_ID', default='miya')
MIYA_MASTRA_API_KEY = config('MIYA_MASTRA_API_KEY', default='')
# Mastra Cloud platform API token (alternative to MIYA_MASTRA_API_KEY for /generate auth)
MIYA_MASTRA_API_TOKEN = config('MIYA_MASTRA_API_TOKEN', default='')
MASTRA_API_TOKEN = config('MASTRA_API_TOKEN', default='')
...
CELERY_BEAT_SCHEDULE = {
    ...
    "ops_live_stale_sweep": {
        "task": "dashboard.tasks.ops_live_stale_sweep",
